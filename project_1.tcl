...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/src/sim/AES_AXI_tb.sv"]"\
  ]
  foreach ifile $files {
...
set file "$origin_dir/src/sim/AES_AXI_tb.sv"
...
set obj [get_filesets sim_1]
set_property -name "top" -value "AES_AXI_tb" -objects $obj
...
# aes
  ...
  set in_IV [ create_bd_port -dir I -from 127 -to 0 in_IV ]
  set in_key [ create_bd_port -dir I -from 255 -to 0 in_key ]
  ...
  connect_bd_intf_net -intf_net aes_0_m00_axi [get_bd_intf_pins aes_0/m00_axi] [get_bd_intf_pins axi_interconnect_1/S00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_vip_1_M_AXI [get_bd_intf_pins axi_interconnect_1/S01_AXI] [get_bd_intf_pins axi_vip_1/M_AXI]

  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_ports aclk] [get_bd_pins aes_0/clk] [get_bd_pins aes_0/m00_axi_aclk] [get_bd_pins aes_0/s00_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins axi_vip_0/aclk] [get_bd_pins axi_vip_1/aclk]
  connect_bd_net -net aresetn_1 [get_bd_ports aresetn] [get_bd_pins aes_0/m00_axi_aresetn] [get_bd_pins aes_0/reset_n] [get_bd_pins aes_0/s00_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins axi_vip_0/aresetn] [get_bd_pins axi_vip_1/aresetn]
  connect_bd_net -net in_IV_1 [get_bd_ports in_IV] [get_bd_pins aes_0/in_IV]
  connect_bd_net -net in_key_1 [get_bd_ports in_key] [get_bd_pins aes_0/in_key]

  # Create address segments
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces aes_0/m00_axi] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces axi_vip_0/Master_AXI] [get_bd_addr_segs aes_0/s00_axi/reg0] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces axi_vip_1/Master_AXI] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
